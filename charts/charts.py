diff --git a/charts/charts.py b/charts/charts.py
index 9b8767e91098ee7b51b18c954de6251ac81773f1..2f97c0adc1acad69bc71f534726e37518d4db248 100644
--- a/charts/charts.py
+++ b/charts/charts.py
@@ -1,86 +1,94 @@
...
+    TeamSelect_TP = alt.selection_point(
+        name="TeamSelect_TP",
+        fields=["team"],
+        toggle=False
+    )
...
+    TeamSelect_GD = alt.selection_point(
+        name="TeamSelect_GD",
+        fields=["team"],
+        toggle=False
+    )
...
@@ -89,99 +97,107 @@ def chart_goal_difference(team_summary):
...
+    TeamSelect_ROLL = alt.selection_point(
...
+    TeamSelect_HA = alt.selection_point(
+        name="TeamSelect_HA",
+        fields=["team"],
+        toggle=False
+    )
